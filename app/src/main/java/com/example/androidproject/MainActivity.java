    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(MainActivity.this,Signupoptions.class);
                startActivity(i);
                finish();
            }
        });
                ...
                firebaseAuth.signInWithEmailAndPassword(s1,s2).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull @NotNull Task<AuthResult> task) {
                        if(task.isSuccessful())
                        {
                            ...
                            Intent j= new Intent(MainActivity.this,Entrypage1.class);
                            startActivity(j);
                            finish();
                        }
                        else
                        {
                            ...
                            p1.setVisibility(View.INVISIBLE);
                            Intent k=new Intent(MainActivity.this,Signupoptions.class);
                            startActivity(k);
                            finish();
                        }
                    }
